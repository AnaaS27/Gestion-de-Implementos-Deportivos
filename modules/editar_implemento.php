...
$implemento = null; // Variable para almacenar los datos del implemento si se encuentra
...
if (isset($_POST['buscar'])) {
    ...
    // Si no se encuentra el implemento, se asigna un mensaje
    if (!$implemento) {
...
if (isset($_POST['actualizar'])) {
    ...
    // Consulta SQL para actualizar el implemento
